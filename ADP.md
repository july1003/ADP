# 📕 ADP 필기 합격 통합 마스터 가이드 (최종 심화본)

알겠습니다! 한꺼번에 많은 내용을 다루기보다, 요청하신 대로 **1과목: 데이터 이해** 파트를 챕터별로 쪼개어 **Full Name(풀네임) 표기, 상세 이론, 장단점, 수식, 그리고 시험 키포인트**를 꽉 채워 다시 정리해 드립니다.

아이패드에서 공부하실 때 가독성이 좋도록 구조화했습니다.
